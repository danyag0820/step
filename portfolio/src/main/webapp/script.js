...
/**
 * Fetches json string from the server, converts to text, and adds it to the
 * DOM.
 */
...
function createMessageListElt(messageList) {
  ...
  for (i = 0; i < messageList.length; i++) {
    ...
    var messageContent = document.createTextNode(
        messageList[i].name + '(' + messageList[i].email +
        '): ' + messageList[i].text);
      ...
      .then((icebergSightings) => {
        ...
        icebergSightings.forEach((iceberg) => {
          ...
          var contentString = '<div id="content">' +
              '<p>iceberg size: </p>' + iceberg.size + '</div>' +
              '</div>';
...
function loadImages() {
  var images = [
    '/images/friendImages/IMG-0490.JPG', '/images/natureImages/IMG-0516.JPG',
    '/images/natureImages/IMG-3893.JPG', '/images/friendImages/snowman.JPG',
    '/images/natureImages/IMG-4799.JPG', '/images/friendImages/IMG-2559.JPG',
    '/images/natureImages/IMG-4901.JPG', '/images/natureImages/IMG-5025.JPG',
    '/images/friendImages/IMG-7364.JPG', '/images/natureImages/IMG-6283.JPG',
...
/**
 * Fetches iceberg sightings data from the server and displays size
